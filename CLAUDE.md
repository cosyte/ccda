...
The full section is in
[engineering-standards.md](documentation/engineering-standards.md).

## Engineering Guardrails

The full section is in
[engineering-standards.md](documentation/engineering-standards.md). **Read it before you
change code**: the `attw` wrapper trap lives there, and it is one of the traps above, not a
style note.
