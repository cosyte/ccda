...
the V3 `2015-08-01` stamp with no entries-required variant) emits one or more Smoking Status (Meaningful Use)
observations (`…22.4.78`, the `2014-06-09` stamp), each with the fixed LOINC `code`
