 ...
 * attributes (e.g. `sdtc:raceCode`). An **element** outside this set is
 * retained and flagged with `UNKNOWN_NAMESPACE_PREFIX`, once per distinct
 * foreign namespace, by the DOM walk in `./secure-xml.ts`. Attributes are not
