...
- e726a86: **This is 0.1.0, the first release whose public API we treat as settled.**
...
- 6a8c4f8: feat: report a coded value that sits outside the value set its slot is bound to
...
- f521d8f: feat: read the header participations, so a parsed document can say who authored it
...
- 2780242: Build an inpatient Discharge Summary, the third of the twelve document types
